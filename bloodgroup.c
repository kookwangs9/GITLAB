...
{ char Name[50], G[5], answer[10];
  ...
  do
  {
    printf("What is your name kaaaaaaa khun P? ");
    scanf("%s", Name);
    do
    {
      printf("What is your blood group kaaa [A, B, AB, or O]? ");
      scanf("%s", G);
      ...
      if (strcmp(G, "A") !=0  &&
                            ...
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 )
        printf("Blood group %s is incorrect! Please try again naaaa.\n", G);
    }  while (strcmp(G, "A") !=0  &&
                            strcmp(G, "B") !=0  &&
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 );
    if (strcmp(G,"A") ==0)
    {
      printf("%s, A. Hey sissss, you can give blood to: A, AB.\n", Name);
    ...
    {
      printf("%s, AB. Oh my Goddd, you can give blood "only" to: AB.\n", Name);
